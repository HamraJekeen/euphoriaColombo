<div class="bg-white">
<div class="w-full h-screen bg-[url('/public/images/home2.jpg')] bg-cover bg-center flex flex-col justify-end py-10 px-4 sm:px-6 lg:px-8 mx-auto">



  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">

      <div class="text-center"> <!-- Optional: text-center to center-align text/buttons -->
        <h1 class="block text-3xl font-bold text-gray-100 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
          Be Spoit For Choice<span class="text-blue-600">   </span>
        </h1>

        <!-- Buttons -->
        <div class="mt-7 grid gap-3 w-full sm:inline-flex">
          <a class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-amber-600 text-white hover:bg-amber-400 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/register">
            Shop Now
...
<div >
    <img src="{{ asset('images/icon.png') }}" alt="Icon Image">
...
<section class="py-0">
  <div class="max-w-xl mx-auto">
    <div class="text-center ">
      <div class="relative flex flex-col items-center">
        <h1 class="text-5xl font-bold dark:text-gray-200"> <span class="text-blue-500"> 
          </span> </h1>
  ...
  <div class="justify-center max-w-8xl px-4 py-4 mx-auto lg:py-0">
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3 md:grid-cols-2">
      @foreach ($categories as $category )

      <div class="bg-[url('storage', $category->image')] bg-white rounded-lg shadow-md dark:bg-gray-800" wire:key="{{$category->id}}">
        <a href="/products?selected_categories[0] = {{ $category->id }}" class="">
          <img src="{{url('storage', $category->image)}}" alt="{{$category->name}}" class="object-cover w-full h-64 rounded-t-lg">
        </a>
        <div class="p-5 text-right">
            
          <a href="/products?selected_categories[0] = {{ $category->id }}" class="text-4xl font-bold tracking-tight text-gray-900 dark:text-gray-300">
            {{$category->name}}
          </a>
        </div>
      </div>
...
<section class="py-0">
  ...
  <div class="justify-center max-w-8xl px-0 py-0 mx-auto lg:py-0">
    <div class="grid grid-cols-1 gap-0 lg:grid-cols-2 md:grid-cols-2">
      <div class="bg-white shadow-md dark:bg-gray-800">
        <a href="" class="">
          <img src="{{ asset('images/about2.png') }}" alt="" class="object-cover w-full lg-h-64 ">
        </a>
      ...
      <div class=" bg-white  shadow-md dark:bg-gray-800">
        <img src="{{ asset('images/about1.png') }}" alt=""  class="object-cover w-full lg-h-96 ">
