...
<div class="w-full h-screen bg-[url('/public/images/chainpro.jpg')] bg-cover bg-center flex flex-col justify-end py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  ...
  <div class="relative -top-80 text-center"> <!-- Add relative and top classes here -->
  <h1 class="block text-1xl text-black sm:text-2xl lg:text-4xl lg:leading-tight dark:text-white">
        ...
        <div class="w-full pr-2 lg:w-1/4 lg:block">
          ...
          <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
            ...
            <div>
              ...
              <input type="range"  wire:model.live="price_range"  class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer" max="3000" value="1000" step="500">
              <div class="flex justify-between ">
                <span class="inline-block text-lg font-bold text-blue-400 ">{{Number::currency(500,'LKR')}}</span>
                <span class="inline-block text-lg font-bold text-blue-400 ">{{Number::currency(3000,'LKR')}}</span>
              </div>
            </div>
          </div>
        </div>
