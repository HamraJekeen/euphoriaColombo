        ...
        <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{url('storage', $product->image[0])}}' }">
          <div class="sticky top-0 z-50 overflow-hidden ">
            ...
            <div class="flex-wrap hidden md:flex ">
              ...
              <div class="w-1/2 p-2 sm:w-1/4" x-on:click="mainImage='{{url('storage', $product->image)}}'">
                <img src="{{url('storage', $product->image)}}" alt="{{$product->name}}" class="object-cover w-full lg:h-20 cursor-pointer hover:border hover:border-blue-500">
              </div>
              @endforeach
